...
namespace Cafe {
    ...
    public partial class TestDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentRow AddStudentRow(int Id, string Password, string UserName, string FirstName, string LastName) {
...
namespace Cafe.TestDBDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([Id], [Password], [UserName], [FirstName], [LastName" +
                "]) VALUES (@Id, @Password, @UserName, @FirstName, @LastName);\r\nSELECT Id, Passwo" +
                "rd, UserName, FirstName, LastName FROM Student WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Id] = @Id, [Password] = @Password, [UserName] = @UserName, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([Id] = @Original_Id) AND ([Password] = @Original_Password) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)));
SELECT Id, Password, UserName, FirstName, LastName FROM Student WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Password, UserName, FirstName, LastName FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Id, string Original_Password, string Original_UserName, string Original_FirstName, string Original_LastName) {
        ...
        public virtual int Insert(int Id, string Password, string UserName, string FirstName, string LastName) {
        ...
        public virtual int Update(int Id, string Password, string UserName, string FirstName, string LastName, int Original_Id, string Original_Password, string Original_UserName, string Original_FirstName, string Original_LastName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string UserName, string FirstName, string LastName, int Original_Id, string Original_Password, string Original_UserName, string Original_FirstName, string Original_LastName) {
            return this.Update(Original_Id, Password, UserName, FirstName, LastName, Original_Id, Original_Password, Original_UserName, Original_FirstName, Original_LastName);
        }
    }
